...
from widgets.student_widgets.students_info import Students_info
...
from widgets.student_widgets.setting_pivot import setting_pivot

class StudentWindow(FramelessWindow):
    ...
    def creat_Navigation_stack(self):
        ...
        # 创建子界面
        # 个人信息
        self.students_info = Students_info(self)
        # 学年成绩
        self.student_grade_byYear = students_grade_year_widget(self)
        self.student_grade_byYear.Sno_lineEdit.setText(self.username)
        self.student_grade_byYear.Sno_lineEdit.setEnabled(False)

        # 按学分筛选成绩 
        self.student_total_credits = Students_lesson_credits_year(self)
        self.student_total_credits.Sno_LineEdit.setText(self.username)
        self.student_total_credits.Sno_LineEdit.setReadOnly(True)
        self.student_total_credits.Sno_LineEdit.setEnabled(False)
        
        # 学生课表
        self.schedule_student = schedule_student(self)
        self.schedule_student.Sno_LineEdit.setText(self.username)
        self.schedule_student.Sno_LineEdit.setEnabled(False)
    
        # 班级课表
        self.schedule_class = schedule_class(self)
        self.schedule_class.Cno_LineEdit.setText("03342102")
        self.schedule_class.Cno_LineEdit.setReadOnly(True)
        self.schedule_class.Cno_LineEdit.setEnabled(False)
    ...
    def createAvw_andAdd(self):
        ...
        avw.setName("学生用户" + str(self.username))
        avw.setAvatr("icon/student.jpg")
        # 添加自定义小部件到底部
    ...
    def initNavigation(self):
        # 部件 图标 文本名
        self.addSubInterface(self.students_info, FIF.FEEDBACK, '学生个人信息', NavigationItemPosition.SCROLL)
        ...
        self.addSubInterface(self.student_total_credits, FIF.SEARCH, '学生课程成绩及学分学年统计', NavigationItemPosition.SCROLL)
    ...
    def initWindow(self):
        ...
        self.setWindowIcon(QIcon('icon/student_bar.jpg'))
        self.setWindowTitle('学生用户界面')
        # 设置标题栏的背景为样式化背景
